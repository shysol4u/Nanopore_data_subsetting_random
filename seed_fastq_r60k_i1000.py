...
def main():
    parser = argparse.ArgumentParser(description="Extract 60k random Nanopore reads from multiple simulations.")
    parser.add_argument("fastq", type=Path, help="Input FASTQ file")
    parser.add_argument("-n", "--n_reads", type=int, default=60000, help="Number of reads to extract")
    parser.add_argument("-s", "--simulations", type=int, default=1000, help="Number of simulations to run")
    parser.add_argument("-o", "--output", type=Path, default="final_sampled_60k.fastq", help="Output FASTQ filename")
